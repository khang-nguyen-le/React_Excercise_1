        ...
        <div className="section-body">
          <section className="hero  py-5">
            <div className="container">
              <div className="hero__content bg-light p-5 rounded text-center">
                <div className="hero__heading  p-5">
                  <h1 className="hero__heading-title fw-bold fs-1 display-5">
                    A warm welcome!
                  </h1>
                  <p className="hero__heading-subtitle fs-4">
                  ...
                  <div className="col-4 mb-5">
                    <div className="card bg-light border-0 h-100">
                      <div className="card-body text-center pt-0 p-5">
                        <div
                          className="feature__icon d-inline-flex p-3 bg-primary text-white rounded mb-4"
                          style={{ marginTop: -24 }}
                        >
                          <svg
